...
class AddReviewView(LoginRequiredMixin,View):
    def post(self,request,id):
        ...
        return render(request,'books/detail.html',{'review_form':review_form,'book':book})
...
class EditReviewView(LoginRequiredMixin,View):
    ...
    def post(self, request,book_id,review_id):
        ...
        return render(request,'books/detail.html',{'review_form':review_form,'book':book,'review':review})
